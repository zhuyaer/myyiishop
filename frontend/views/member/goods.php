...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="<?=\yii\helpers\Url::to(['member/index'])?>">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> > ThinkPad X230(23063T4）12.5英寸笔记本</h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$goodsPhotos[0]->path?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$goodsPhotos[0]->path?>" alt="" style="max-width: 350px"/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                ...
                                <?php foreach ($goodsPhotos as $i=>$photo):?>
                                    <?php if ($i == 0) { ?>
                                        <li class="cur">
                                            <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$photo->path?>',largeimage: '<?=$photo->path?>'}"><img src="<?=$photo->path?>"></a>
                                        </li>
                                    <?php } else {?>
                                        <li class="cur">
